...
using Liuliu.MouseClicker.Models.Enums;
...
namespace Liuliu.MouseClicker.Tasks
{
    public class SmallTool : TaskBase
    {
        ...
        private EquipSuitEnum equipSuit = EquipSuitEnum.None;
        ...
        public void SetValue(List<套装> list,int i)
        {
            list[i].麒麟双枪.IsHave = true;
            list[i].麒麟.IsHave = true;
            list[i].三昧纯阳铠.IsHave = true;
            list[i].蝶凤舞阳.IsHave = true;
            list[i].伏龙帅印.IsHave = true;
            list[i].蟠龙华盖.IsHave = true;
