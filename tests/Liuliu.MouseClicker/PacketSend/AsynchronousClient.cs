    ...
    public class AsynchronousClient
    {
        ...
        private void DealData(byte[] recvarr)
        {
            ...
            for (int i = 0; i < lst.Count; i++)
            {
               ...
               Debug.WriteLine("报文解析:" + pair.Key + "=" + pair.Value);
            }
        ...
        public static List<KeyValuePair<string, string>> getZipByteArr(byte[] recvarr)
        {
            ...
            try
            {
                while (index != -1)
                {
                    ...
                    {// 格式不正确的报文不解析
                        ...
                        Debug.WriteLine("无法解析的报文,字节数组=" + str + ";iindex=" + index);
            ...
            catch (Exception ex)
            {
                ...
                Debug.WriteLine("解析时发生异常,字节数组=" + str + ";index=" + index);
        ...
        public void Send(byte[] byteData)
        {
            ...
            {
                Debug.WriteLine("发送数据异常,ErrorMsg=" + ex.Message);
            }
        }
